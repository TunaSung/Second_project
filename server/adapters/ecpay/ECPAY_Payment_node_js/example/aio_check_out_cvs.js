...
const cvs_params = {
  ...
  client_redirect = 'http://192.168.0.1/payment_result',
  options = require('../conf/config-example'),
  create = new ecpay_payment(options),
  htm = create.payment_client.aio_check_out_cvs(cvs_info = cvs_params, parameters = base_param, invoice = inv_params, client_redirect_url = client_redirect) //取得綠界CVS付款表單HTML，我們需要的參數有
console.log(htm)
