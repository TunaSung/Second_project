...
function History({ completedOrder = [], pendingOrder = [], loading = false }) {
  ...
  return (
  <div className="bg-[var(--secondary-color)] z-50 sticky top-1/4 w-full mt-50 py-15 flex flex-col justify-center items-center">
      {/* start title */}
      ...
      <div className="w-[90%] min-h-100">
        ...
        <div className="w-full h-15 pl-8 flex items-end">
          <motion.button
            className="border border-slate-400 border-b-0 w-35 h-3/4 px-3 rounded-t-xl"
          ...
          <motion.button
            className="border border-slate-400 w-35 2/3 px-3 rounded-t-xl"
        ...
        <div className="flex flex-col gap-rwd rounded-xl ">
          {loading ? (
            <div className="w-full h-100 flex justify-center items-center">
              <l-dot-stream size="40" speed="2.2" color="black" />
            </div>
          ) : isCompleted ? (
