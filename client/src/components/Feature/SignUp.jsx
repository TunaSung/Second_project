                ...
                <div className=" flex w-full h-full rounded-2xl flex-col items-center pt-6">
                    ...
                    <div className="w-full h-12 flex items-center mb-5">
                        <div className="flex pl-3 items-center w-full h-full ">
                            <label htmlFor="username" className="text-2xl mr-2"><MdOutlineDriveFileRenameOutline /></label>
                            <input 
                            type="text"
                            id="username"
                            value={username} 
                    ...
                    <div className="w-full h-12 flex items-center mb-5">
                        <div className="flex pl-3 items-center w-full h-full ">
                            <label htmlFor="phone-number" className="text-2xl mr-2"><MdOutlinePhone /></label>
                            <input 
                            type="text"
                            id="phone-number"
                            value={phone} 
                    ...
                    <div className="w-full h-12 flex items-center mb-5">
                        <div className="flex pl-3 items-center w-full h-full ">
                            <label htmlFor="sign-up-email" className="text-2xl mr-2"><IoPersonOutline/></label>
                            <input 
                            type="email"
                            id="sign-up-email" 
                            value={email} 
                    ...
                    <div className="w-full h-12 flex items-center mb-5">
                        <div className="flex  pl-3 items-center w-full h-full ">
                            <label htmlFor="sign-up-password" className="text-2xl mr-2"><TbLockPassword /></label>
                            <input 
                            type="password" 
                            id="sign-up-password"
                            value={password}
                    ...
                    <div className="w-full h-12 flex items-center mb-5">
                        <div className="flex  pl-3 items-center w-full h-full ">
                            <label htmlFor="confirm-password" className="text-2xl mr-2"><RiLockPasswordFill /></label>
                            <input 
                            type="password" 
                            id="confirm-password"
                            value={confirm}
                    ...
                    {/* start btn */}
                    <button type="submit" className="rounded-lg mb-3 bg-black/60 py-3 w-3/4 text-[#ccc] hover:text-white hover:bg-black/40 cursor-pointer">
                        Sign Up
                    </button>
                    {/* end btn */}
