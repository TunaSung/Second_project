        ...
        <div id="footer" className="py-10 w-full font-bold bg-[#333] text-[#ccc]">
            <div id="container" className="container-mid flex justify-center items-center flex-col">
                <div id="row" className="row grid grid-cols-3 gap-rwd mb-5">
                    <a href="#!" className="text-center text-xl hover:text-blue-700 transition-all duration-200">Inspection report</a>
                    <a href="#!" className="text-center text-xl hover:text-blue-700 transition-all duration-200">Privacy rights</a>
                    <a href="#!" className="text-center text-xl hover:text-blue-700 transition-all duration-200">Statement announcement</a>
                </div>
